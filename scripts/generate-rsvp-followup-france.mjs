#!/usr/bin/env node
/**
 * Generate the France RSVP follow-up workbooks.
 *
 ...
 *
 * Usage:
 *   node scripts/generate-rsvp-followup-france.mjs
 *
 * Output:
 *   scripts/output/rsvp-followup-france-{Gross,Ancels,Sargaux}-YYYYMMDD.xlsx
 *
